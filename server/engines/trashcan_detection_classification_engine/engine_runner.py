...
from your_engine import TrashCanDetectionClassificationEngine
...
DEFAULT_PORT = 9098
DEFAULT_SOURCE_NAME = "trash_can_filter"
ONE_MINUTE = 60000
...
def main():
    ...
    example_engine = TrashCanDetectionClassificationEngine(args.source_name, args.visualize, args.save_raw, args.use_livemap)
